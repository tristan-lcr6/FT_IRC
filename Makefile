...
# Source files
SRC_DIR = src/
SRC_FILES = main.cpp Server.cpp Client.cpp Channel_client-op.cpp Channel_getters.cpp Channel_inv-tpc-psw-lim.cpp Channel_mode.cpp Channel_OCF.cpp utils.cpp privmsg.cpp
