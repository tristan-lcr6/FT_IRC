...
# Source files
SRC_DIR = src/
SRC_FILES = main.cpp Server.cpp Client_buffer.cpp Client_OCF.cpp Client_getters.cpp Client_operators.cpp Client_setters.cpp Channel_client-op.cpp Channel_getters.cpp Channel_inv-tpc-psw-lim.cpp Channel_mode.cpp Channel_OCF.cpp utils.cpp privmsg.cpp
